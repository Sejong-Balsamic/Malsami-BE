...
//        );
//
//        ftpStorageService.uploadDocument(file, FileUtil.generateUploadFileName(file));
...
//      try {
//        ftpStorageService.deleteDocument(fileName);
...
//        }
//
//        ftpStorageService.uploadThumbnailBytes(thumbnail, thumbnailFilename);
...
//      ftpStorageService.uploadThumbnailBytes(outputStream.toByteArray(), webpFilename);
//
