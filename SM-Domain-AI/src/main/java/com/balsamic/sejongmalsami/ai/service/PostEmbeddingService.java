...
public class PostEmbeddingService {
  ...
  // private final SearchHistoryService searchHistoryService; // Post 도메인 서비스 제거
  ...
  public EmbeddingDto searchSimilarEmbeddingsByText(EmbeddingCommand command) {
    try {
      // 캐시를 통해 embedding 확보
      // TODO: SearchQueryCacheService 의존성 제거로 인한 임시 처리
      ...
      redisLockManager.executeLock(lockKey, WAIT_TIME, LEASE_TIME, () -> {
        // TODO: SearchHistoryService 의존성 제거로 인한 임시 처리
