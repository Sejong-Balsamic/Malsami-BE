...
public class SejongPortalAuthenticator {
   ...
   * @return AuthDto(학과, 학번, 이름, 학년, 등록상태 등)
   */
  public AuthDto getMemberAuthInfos(AuthCommand command) {
   ...
   * @return AuthDto
   */
  private AuthDto getTestInfos(String testMemberStudentId, String testMemberPassword) {
   ...
   * @return AuthDto
   */
  private AuthDto parseHTMLAndGetMemberInfo(String html) {
