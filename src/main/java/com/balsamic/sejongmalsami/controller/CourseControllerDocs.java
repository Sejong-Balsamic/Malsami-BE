...
public interface CourseControllerDocs {
  ...
  @Operation(
      ...
      description = """
            ...
            **업로드 파일 포맷:**
            - 파일명은 `course-YYYY-S.xlsx` 형식을 따라야 합니다. 예를 들어, `course-2024-2.xlsx`.
            - 파일은 `.xlsx` 형식의 엑셀 파일이어야 하며, 첫 번째 시트에 다음과 같은 구조로 데이터가 있어야 합니다:
            ...
            **비동기 처리:**
            - 이 API는 비동기 방식으로 처리됩니다. 요청이 수락되면 즉시 응답이 반환되며, 파일 처리는 백그라운드에서 진행됩니다.
            ...
            **반환 파라미터:**
            ...
            - 반환값이 없지만, 요청이 성공적으로 수락되었음을 나타내는 상태 코드가 반환됩니다.
