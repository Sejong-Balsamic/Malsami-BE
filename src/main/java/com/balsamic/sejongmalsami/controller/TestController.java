...
public class TestController {
  ...
  description = """
       ...
       **동작 방식:**
       ...
       4. **반복:** 총 생성된 질문 글의 개수가 `postCount`에 도달할 때까지 위 과정을 반복합니다.
       ...
       **사용 예시:**
       ...
       - `postCount`가 **50**인 경우, 50개의 질문 글과 각각에 대응하는 답변 글이 생성됩니다.
       - `postCount`를 지정하지 않으면, 기본적으로 30개의 질문 글과 그에 따른 답변 글이 생성됩니다.
